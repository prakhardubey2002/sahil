...
const footer_content = { 
    contact_us: <> Contact us at <span>@avonimpex.com </span></>,
    mail: "info@avonimpex.com",
    contact_text: "PERFECT SOLUTION From  Cleaning Supplies",
    phone: "+971-54-756-3743",
    info: <>The world’s first and largest digital market for crypto collectibles and non-fungible (NFTs). Buy</>,
    map: "#",
    address: <>27428, <br /> DUBAI UAE</>,
    mail_2: "info@avonimpex.com",
    mail_phone: <> info@avonimpex.com <br /> +971-54-756-3743</>,
                                ...
                                <div className="col-lg-6">
                                    <div className="tp-footer-top-right d-flex justify-content-start justify-content-lg-end">
                                        ...
                                        <div className="tp-footer-top-right-content">
                                            <p>{contact_text}</p>
                                            <a href={`tel:${phone}`}>+971-54-756-3743</a>
                                        </div>
                                    </div>
                                </div>
                                </div>
                    ...
                    <div className="tp-footer-main-area">
                        <div className="row">
                            ...
                            <div className="col-xl-3 col-lg-4 col-md-6">
                                ...
                                <h3 className="tp-footer-widget-title">Our Products</h3>
                                <div className="tp-footer-widget-content">
                                    <ul>
